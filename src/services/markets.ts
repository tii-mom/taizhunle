...
const MARKET_LIST: MarketCard[] = [
  {
    ...
    pool: 32406,
    bets: [
      { id: 'btc-1', user: 'Amber', amount: 2500, market: 'btc', direction: 'long', timestamp: 1740200000 },
      { id: 'btc-2', user: 'Blue', amount: 1100, market: 'btc', direction: 'short', timestamp: 1740198000 },
      { id: 'btc-3', user: 'Whale A', amount: 4200, market: 'btc', direction: 'long', timestamp: 1740196000 },
    ],
  },
  {
    id: 'eth',
    ...
    pool: 12887,
    bets: [
      { id: 'eth-1', user: 'Validator', amount: 800, market: 'eth', direction: 'long', timestamp: 1740195000 },
      { id: 'eth-2', user: 'DeFi Scout', amount: 1400, market: 'eth', direction: 'long', timestamp: 1740193000 },
      { id: 'eth-3', user: 'Whale B', amount: 1200, market: 'eth', direction: 'short', timestamp: 1740192000 },
    ],
  },
  {
    id: 'ton',
